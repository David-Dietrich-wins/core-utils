...
describe('formatters', () => {
  ...
  it('percentTimes100Formatter', () => {
    ...
    expect(percentTimes100Formatter(1000000.1, false, 3)).toBe(
      '100,000,010.000%'
    )
  })

  it('stockVolumeFormatter', () => {
    ...
    expect(
      stockVolumeFormatter(undefined, true, null as unknown as number)
    ).toBe('0')
